...
export const rankingSeoPages: RankingSeoPage[] = [
  ...
  },
  {
    ...
    "faqs": [
      ...
      {
        "q": "Do you provide home theater installation in Karachi?",
        "a": "Yes, we provide professional home theater installation in Karachi and throughout Pakistan, with local expertise in power handling and construction requirements."
      }
    ],
    "links": [
      {
