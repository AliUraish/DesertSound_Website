...
import { theatreServiceFaqs } from "./theatre-service-faqs"
...
const sitePages: RankingSeoPage[] = [
  ...
  },
  {
    ...
    "description": "Home theater installation across Pakistan from our Karachi HQ in DHA. We design, install, and calibrate cinema rooms — site visits in DHA, Clifton, and nationwide.",
