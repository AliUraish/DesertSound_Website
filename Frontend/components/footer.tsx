      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-16 lg:py-20">
        ...
        <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-8 lg:gap-0 mb-8">
          ...
          <div className="flex-1 max-w-lg">
            ...
            <div className="space-y-4">
              ...
              <p className="text-sm text-black/60 leading-relaxed max-w-md">
                Subscribe to receive <span className="text-black/85 font-medium">early access</span> to premium releases, <span className="text-black/85 font-medium">limited drops</span>, and <span className="text-black/85 font-medium">private launch notifications</span> before anyone else.
              </p>
              ...
              <form onSubmit={handleNewsletterSubmit} className="relative max-w-md">
                <input
                  ...
                  required
                  className="w-full px-4 py-3 pr-11 bg-white border border-black/10 text-sm text-black placeholder:text-black/40 focus:outline-none focus:border-black/40 transition-colors shadow-sm"
                />
                <button
                  type="submit"
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-8 lg:gap-10">
            ...
            <nav className="flex items-center gap-5 lg:gap-7">
              <Link href="/#services" className="text-black/60 hover:text-black transition-colors text-sm">
                Services
              </Link>
              <Link href="/#contact" className="text-black/60 hover:text-black transition-colors text-sm">
                Contact
              </Link>
            </nav>
            ...
            <div className="flex items-center gap-3">
              <a 
                href="#" 
                className="w-9 h-9 rounded-full bg-black/10 flex items-center justify-center text-black/60 hover:bg-black hover:text-[#F5F5DC] transition-all duration-300"
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pt-8 border-t border-black/10">
          ...
          <div className="flex items-center gap-6">
            <a href="#" className="text-black/45 hover:text-black/70 transition-colors text-sm">
              Privacy
            </a>
            <a href="#" className="text-black/45 hover:text-black/70 transition-colors text-sm">
              Terms
