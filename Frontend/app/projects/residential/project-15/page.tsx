...
export default function Project15Page() {
  return (
    <ProjectCaseStudyPage
      ...
      description={[
        "This compact residential entertainment room is built around layered comfort, controlled lighting, and a refined cinema mood. The design direction aims to keep the room elegant and relaxed while supporting an immersive viewing experience.",
