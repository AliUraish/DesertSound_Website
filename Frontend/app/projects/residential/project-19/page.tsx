...
export default function Project19Page() {
  return (
    <ProjectCaseStudyPage
      ...
      description={[
        "Rich-Finish Entertainment Room presents a residential entertainment room built around rich finishes, relaxed seating, and a dramatic cinematic mood. The design intent is to keep the space comfortable for everyday use while giving movie nights a stronger sense of occasion.",
