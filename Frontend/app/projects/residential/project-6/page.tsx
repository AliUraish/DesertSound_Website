...
export default function Project6Page() {
  return (
    <ProjectCaseStudyPage
      ...
      description={[
        "This residential cinema is shaped around a darker material palette, layered detailing, and a clear focus on immersive comfort. The room is intended to feel premium and composed while keeping the technology visually controlled within the architecture.",
