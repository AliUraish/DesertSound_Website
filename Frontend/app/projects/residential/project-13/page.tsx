...
export default function Project13Page() {
  return (
    <ProjectCaseStudyPage
      ...
      description={[
        "This residential cinema is designed around clean geometry, controlled ambiance, and a calm visual hierarchy. The space is intended to feel polished and livable while still delivering the focus and comfort expected from a dedicated entertainment room.",
