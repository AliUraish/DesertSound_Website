...
export default function Project18Page() {
  return (
    <ProjectCaseStudyPage
      title="Project 18"
      coverImage="/Pictures%20Final/Projects/Residential/project_18/img_1.jpg"
      coverImageAlt="Project 18 main image"
      galleryImages={["/Pictures%20Final/Projects/Residential/project_18/img_2.jpg", "/Pictures%20Final/Projects/Residential/project_18/img_3.jpg"]}
      description={[
