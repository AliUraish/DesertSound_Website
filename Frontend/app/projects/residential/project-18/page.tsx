...
export default function Project18Page() {
  return (
    <ProjectCaseStudyPage
      ...
      description={[
        "This residential showcase is centered on soft ambiance, clean detailing, and a strong focal presentation wall. The overall composition is meant to feel polished and livable while preserving the atmosphere expected from a dedicated cinema space.",
