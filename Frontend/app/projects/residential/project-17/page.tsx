...
export default function Project17Page() {
  return (
    <ProjectCaseStudyPage
      ...
      description={[
        "This private cinema room is intended to feel intimate, practical, and visually resolved. The layout leans on clean composition and balanced finishes so the technology supports the space without overpowering it.",
