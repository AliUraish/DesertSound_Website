...
export default function Project21Page() {
  return (
    <ProjectCaseStudyPage
      ...
      description={[
        "Balanced-Contrast Home Cinema is a private cinema environment designed around tonal contrast, comfort, and a clean room layout that keeps the visual focus where it belongs. The space aims to feel composed and premium without losing its residential warmth.",
